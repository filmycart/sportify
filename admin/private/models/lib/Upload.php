...
class Upload{
	...
	public function validate_extension_favico(){
        $img_ext = strtolower($this->extension);
        if($this->type == "img"){
            /*if($img_ext != "ico") {
                return  $this->errors->add_error("Invalid File extension for favicon upload file withext .ico");
            }*/
            if($img_ext != "png") {
                return  $this->errors->add_error("Invalid File extension for favicon upload file withext .png");
            }
        }
    }

    public function validate_extension_loading(){
        $img_ext = strtolower($this->extension);
        if($this->type == "img"){
            /*if($img_ext != "ico") {
                return  $this->errors->add_error("Invalid File extension for favicon upload file withext .ico");
            ...
            if($img_ext != "png") {
                return  $this->errors->add_error("Invalid File extension for loading upload file withext .png");
            }
        }
    }
