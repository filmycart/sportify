<?php
	...
	if((isset($_SERVER['SERVER_NAME'])) && (($_SERVER['SERVER_NAME'] == "localhost") || ($_SERVER['SERVER_NAME'] == "127.0.0.1"))) {
		...
		define("DB_NAME", "sportify"); // Database Name
	}
	else {
		define("DB_SERVER", "localhost"); // Server Name
		define("DB_USER", "sportify"); // Database User
		define("DB_PASS", "sportify"); // Database Password
		define("DB_NAME", "sportify"); // Database Name
	}
	...
	define("ADMIN_FOLER_NAME",'admin');
	define("PUBLIC_PATH", PROJECT_PATH . DIRECTORY_SEPARATOR  . 'admin');
	...
	require_once('models/Contact_Information.php');
