        ...
        if(empty($_POST['id'])){
            ...
            if($ajax_request){
                ...
                if(!$message->is_empty()){
                    ...
                    Helper::redirect_to("../../".ADMIN_FOLER_NAME."/attributes.php");
                }else if(!$errors->is_empty()){
                    Session::set_session($errors);
                    Helper::redirect_to("../../".ADMIN_FOLER_NAME."/attribute-form.php");
                }
            }
            ...
            if($ajax_request){
                ...
                if(!$message->is_empty()){
                    ...
                    Session::set_session($errors);
                    Helper::redirect_to("../../".ADMIN_FOLER_NAME."/attribute-form.php?id=" . $attribute->id);
                }
