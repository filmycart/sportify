    ...
    if (Helper::is_post()) {
        ...
        if(empty($_POST['id'])){
            ...
            if(!$message->is_empty()){
                ...
                Helper::redirect_to("../../".ADMIN_FOLER_NAME."/sliders.php");
            }else if(!$errors->is_empty()){
                Session::set_session($errors);
                Helper::redirect_to("../../".ADMIN_FOLER_NAME."/slider-form.php");
            }
            ...
            if(!$message->is_empty()){
                ...
                Session::set_session($errors);
                Helper::redirect_to("../../".ADMIN_FOLER_NAME."/slider-form.php?id=" . $slider->id);
            }
        }
