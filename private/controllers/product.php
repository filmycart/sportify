...
if(empty($admin)){
    ...
    if (Helper::is_post()) {
        ...
        if(empty($_POST['id'])){
            ...
            $product->sub_category_id = trim($_POST['sub_category_id']);
            ...
            if(!$message->is_empty()){
                ...
                Helper::redirect_to("../../".ADMIN_FOLER_NAME."/products.php");
            }else if(!$errors->is_empty()){
                Session::set_session($errors);
                Helper::redirect_to("../../".ADMIN_FOLER_NAME."/product-form.php");
            }
            ...
            if(!$message->is_empty()){
                ...
                Session::set_session($errors);
                Helper::redirect_to("../../".ADMIN_FOLER_NAME."/product-form.php?id=" . $product->id);
            }
        }
