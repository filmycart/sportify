...
<div class="sidebar">
    <ul class="sidebar-list">
        ...
        <!--<li class="<?php echo (!empty($attributes)?$attributes:''); ?>"><a href="attributes.php"><i class="ion-pricetags"></i><span>Attributes</span></a></li>
        <li class="<?php echo (!empty($products)?$products:''); ?>"><a href="products.php"><i class="ion-android-apps"></i><span>Product</span></a></li> -->
        <!--<li class="<?php echo (!empty($orders)?$orders:''); ?>"><a href="orders.php"><i class="ion-android-cart"></i><span>Orders</span></a></li>
        <li class="<?php echo (!empty($payment)?$payment:''); ?>"><a href="payment.php"><i class="ion-cash"></i><span>Payment</span></a></li>-->
        <!--<li class="<?php echo (!empty($users)?$users:''); ?>"><a href="users.php"><i class="ion-person"></i><span>Register Users</span></a></li>
        <li class="<?php echo (!empty($admob)?$admob:''); ?>"><a href="admob.php"><i class="ion-closed-captioning"></i><span>Admob</span></a></li>
        <li class="<?php echo (!empty($push_notifications)?$push_notifications:''); ?>"><a href="push-notifications.php"><i class="ion-ios-bell"></i><span>Push Notification</span></a></li>
        <li class="<?php echo (!empty($sliders)?$sliders:''); ?>"><a href="sliders.php"><i class="ion-android-image"></i><span>Sliders</span></a></li>-->
        <!--<li class="<?php echo (!empty($setting)?$setting:''); ?>"><a href="setting.php"><i class="ion-android-settings"></i><span>Setting</span></a></li>-->
    </ul>
</div><!--sidebar-->
