...
if(!empty($admin)){
    ...
    if(!empty($site_cofig->image_name)){
		$site_cofig->image_name = $site_cofig->image_name;
	}
	else{
		$site_cofig->image_name = "test.png";
	}

	if(!empty($site_cofig->favicon_image_name)){
		$site_cofig->favicon_image_name = $site_cofig->favicon_image_name;
	}
	else{
		$site_cofig->favicon_image_name = "test.png";
	}

	if(!empty($site_cofig->loading_image_name)){
		$site_cofig->loading_image_name = $site_cofig->loading_image_name;
	}
	else{
		$site_cofig->loading_image_name = "test.png";
	}
	...
	<div class="main-content">
		<div class="item-wrapper three">		
				...
				<div class="item-inner">
					...
					<div class="item-content config">
						<form data-validation="true" action="../private/controllers/site_config.php" method="post" enctype="multipart/form-data">
							...
							<input type="hidden" name="favicon_prev_image" value="<?php echo $site_cofig->favicon_image_name; ?>"/>
							<input type="hidden" name="loading_prev_image" value="<?php echo $site_cofig->loading_image_name; ?>"/>
                            ...
                            <div class="image-upload">
                                ...
                                <input type="file" name="image_name" class="image-input" value="<?php echo $site_cofig->favicon_image_name; ?>"/>
                            </div>							
							<label class="control-label" for="file">Favicon(<?php echo "Max Image Size : " . MAX_IMAGE_SIZE . "MB. Required Format : png"; ?>)</label>
                            <div class="image-upload">
								<div class="dplay-tbl">
									<div class="dplay-tbl-cell">
										<img class="max-h-200x uploaded-image" src="<?php if(!empty($site_cofig->favicon_image_name))
											echo UPLOADED_FOLDER . DIRECTORY_SEPARATOR. $site_cofig->favicon_image_name; ?>" alt=""/>
									</div>
								</div>
                                <div class="h-100 upload-content">
                                    <div class="dplay-tbl">
                                ...
                                <input type="file" name="favicon_image_name" class="image-input" value="<?php echo $site_cofig->favicon_image_name; ?>"/>
                            </div>


                            <label class="control-label" for="file">Loading (<?php echo "Max Image Size : " . MAX_IMAGE_SIZE . "MB. Required Format : png"; ?>)</label>
                            <div class="image-upload">
								<div class="dplay-tbl">
									<div class="dplay-tbl-cell">
										<img class="max-h-200x uploaded-image" src="<?php if(!empty($site_cofig->favicon_image_name))
											echo UPLOADED_FOLDER . DIRECTORY_SEPARATOR. $site_cofig->loading_image_name; ?>" alt=""/>
									</div>
								</div>
                                <div class="h-100 upload-content">
                                    <div class="dplay-tbl">
                                ...
                                <input type="file" name="loading_image_name" class="image-input" value="<?php echo $site_cofig->loading_image_name; ?>"/>
                            </div>
			...
			<div class="item">
                ...
                <?php if(Session::get_session_by_key("type") == "contact_information"){
                    if($message) echo $message->format();
                }?>

				<div class="item-inner">
					<h4 class="item-header">Contact Information</h4>

					<div class="item-content config">
						<form data-validation="true" action="../private/controllers/contact_information.php" method="post">
							<input type="hidden" name="id" value="<?php echo $site_cofig->id; ?>"/>
							<input type="hidden" name="admin_id" value="<?php echo $site_cofig->admin_id; ?>"/>

							<label>Address</label>
							<textarea data-required="true" placeholder="Address" name="address" rows="30" col="10"><?php echo $site_cofig->address; ?></textarea>

							<label>Phone Number</label>
							<input type="text" data-required="true" placeholder="Phone Number" name="phone_number" value="<?php echo $site_cofig->phone_number; ?>" />

							<label>E-Mail</label>
							<input type="text" data-required="true" placeholder="E-Mail" name="email" value="<?php echo $site_cofig->email; ?>"/>

							<div class="btn-wrapper"><button type="submit" class="demo-disable c-btn mb-10"><b>Update</b></button></div>
                            <?php 
                            	if(Session::get_session_by_key("type") == "contact_information"){
                                Session::unset_session_by_key("type");
                                if($errors) echo $errors->format();
                            	}
                            ?>
